...
layout: project
type: project
image: img/sulam/pineapple-thumbnail.png
title: "SULAM: Pineapple Connect"
date: 2024-05-15
published: true
labels:
  - Flutter
...
<div class="mt-5">
  ...
  <div class="ratio ratio-16x9 shadow-lg rounded-4 overflow-hidden border">
  ...
  <p class="text-center text-muted mt-2 small italic">Demonstration of the Flutter UI and Firebase real-time synchronization.</p>
</div>

<div class="text-center py-5 d-flex justify-content-center flex-wrap gap-3">
